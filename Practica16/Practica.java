...
public class Practica{
    ...
    public static void juegoEjercito(ArrayList<Ejercito> ejercito1, ArrayList<Ejercito> ejercito2, char[][]tablero){
        ...
        if(ejercito1.size() == 0){
            System.out.println("Salio victorio el reino 2");
            for(Ejercito n: ejercito1){
                System.out.println(n);
            }
        } else if(ejercito2.size()==0){
            System.out.println("Salio victorioso el reino 1");
    ...
    public static int buscadorPosicionEjercito(ArrayList<Ejercito> ejercito, String posicion){
        for(int i = 0; i < ejercito.size(); i++){
            if(posicion.charAt(0) == ejercito.get(i).getPosC() && Integer.parseInt(posicion.substring(1, posicion.length())) == ejercito.get(i).getPosF()){
                return i;
            }
        }
        return 0;
