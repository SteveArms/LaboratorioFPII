...
public class Ejercito {
    ...
    private int cantEspadachinReal = 0;
    private int cantCaballeroFranco = 0;
    private int cantEspadchinTeutocnico = 0;
    private int cantEspadachinConquistador = 0;
    private int cantCaballeroMoro = 0;
    ...
    public void datosSoldados(int numero, char fig){
        ...
        if(reino.toUpperCase().equals("INGLATERRA")){
            for(int i = 0; i < nroSoldados; i++){
                ...
                if(random == 1){
                    ...
                    nombre = (i + 1) + "E" + numero;
                    cantEspadachinReal++;
                    misSoldados.add(new EspadachinReal(nombre, fig));
                } else if(random == 3){
                    nombre = (i + 1) + "A" + numero;
                    cantArquero++;
        ...
        } else if(reino.toUpperCase().equals("FRANCIA")){
            for(int i = 0; i < nroSoldados; i++){
                int random = (int)(Math.random() * 4 + 1);
                if(random == 1){
                    nombre = (i + 1) + "C" + numero;
                    cantCaballero++;
                    misSoldados.add(new CaballeroFranco(nombre, fig));
                } else if( random == 2){
                    nombre = (i + 1) + "E" + numero;
                    cantCaballeroFranco++;
        ...
        } else if((reino.toUpperCase().equals("CASTILLA")) || (reino.toUpperCase().equals("ARAGON"))){
            for(int i = 0; i < nroSoldados; i++){
                int random = (int)(Math.random() * 4 + 1);
                if(random == 1){
                    nombre = (i + 1) + "C" + numero;
                    ...
                    nombre = (i + 1) + "E" + numero;
                    cantEspadachinConquistador++;
                    misSoldados.add(new EspadachinConquistador(nombre, fig));
                } else if(random == 3){
                    nombre = (i + 1) + "A" + numero;
                    cantArquero++;
                    misSoldados.add(new Arquero(nombre, fig));
        ...
        } else if(reino.toUpperCase().equals("MOROS")){
            for(int i = 0; i < nroSoldados; i++){
                int random = (int)(Math.random() * 4 + 1);
                if(random == 1){
                    nombre = (i + 1) + "C" + numero;
                    cantCaballeroMoro++;
                    misSoldados.add(new CaballeroMoro(nombre, fig));
                } else if( random == 2){
                    nombre = (i + 1) + "E" + numero;
                    cantEspadachin++;
                    misSoldados.add(new Espadachin(nombre, fig));
        ...
        } else if(reino.toUpperCase().equals("SACRO")){
            for(int i = 0; i < nroSoldados; i++){
                int random = (int)(Math.random() * 4 + 1);
                if(random == 1){
                    nombre = (i + 1) + "C" + numero;
                    ...
                    nombre = (i + 1) + "E" + numero;
                    cantEspadchinTeutocnico++;
                    misSoldados.add(new EspadachinTeutocnico(nombre, fig));
                } else if(random == 3){
                    nombre = (i + 1) + "A" + numero;
                    cantArquero++;
                    misSoldados.add(new Arquero(nombre, fig));
    ...
    public int getCaballeroMoro(){
        return cantCaballeroMoro;
    }
    public int getCaballeroFranco(){
        return cantCaballeroFranco;
    }
    public int getEspadachinReal(){
        return cantEspadachinReal;
    }
    public int getEspadachinConquistador(){
        return cantEspadachinConquistador;
    }
    public int getEspadachinTeutocnico(){
        return cantEspadchinTeutocnico;
    }
